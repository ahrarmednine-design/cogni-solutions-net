          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                مستقبل الأعمال مع
                <span className="text-gradient block">الذكاء الاصطناعي</span>
              </h1>
              <p className="text-xl text-foreground/80 leading-relaxed">
                نحن شركة رائدة في تقديم حلول الذكاء الاصطناعي المتطورة لتحسين أداء شركتك وأتمتة العمليات بكفاءة عالية
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center space-y-2">
                ...
                <div className="text-sm text-foreground/60">مشروع منجز</div>
              </div>
              <div className="text-center space-y-2">
              ...
              <div className="text-center space-y-2">
                ...
                <div className="text-sm text-foreground/60">معدل النجاح</div>
              </div>
            </div>
          </div>
